...
int main()
{
  ...
  tc
  {
     ...
     //   // ll y1ff=yf +(y1*(x1-1))+(())
     //   // trace(yf)
     //   ll x1ff=x1f+(x1*(y1-1))+((y1-2)*(y1-1))/2;
     //   ll x2ff=x2f+(x2*(y2-1))+((y2-2)*(y2-1))/2;
     //   ll x1last=x1ff+(y2-y1)*(x1+y1-1)+((y2-y1)*(y2-y1-1))/2;
     //   ll x2last=x1ff+(x2-x1)*(x1+y1)+((x2-x1)*(x2-x1-1))/2;
     //   // trace(x1ff)
     //   // trace(x2last)
     //   ll sum_min1=((y2-y1+1)*(2*x1ff+(y2-y1)*(x1+y1-1)))/2 + ((y2-y1)*(y2-y1-1))/2;
     //   ll sum_max1=((y2-y1+1)*(2*x2last+ (y2-y1)*(x2+y1-1)))/2 + ((y2-y1)*(y2-y1-1))/2;
     //   ll sum_min2=((x2-x1+1)*(2*x1last+(x2-x1)*(x1+y2)))/2 +( (x2-x1)*(x2-x1-1))/2;
     //   ll sum_max2=((x2-x1+1)*(2*x1ff+(x2-x1)*(x1+y1)))/2 + ((x2-x1)*(x2-x1-1))/2;
     //   // trace(sum_max1)
     //   // trace(sum_max2)
     //   // trace(sum_min1)
     //   // trace(sum_min2)
     //   ll sum1=sum_min1+sum_min2-x1last;
     //   ll sum2=sum_max1+sum_max2-x2last;
     //   p1(sum2-sum1+1)
     //
     //
     // }
