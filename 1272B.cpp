...
//	clock_t launch=clock();
    ...
    ll ans=min(a[0],a[1])*2+min(a[2],a[3])*2;
    ll ans1=min(a[0],a[1]);
    ll ans2=min(a[2],a[3]);
    if (ans==0) {
      /* code */
    ...
    else
    {
      ...
      if (ans1>=ans2) {
        /* code */
          p1(ans)
        for (size_t i = 0; i < ans2-1; i++) {
          /* code */
          cout<<"LU";
        }
        for (size_t i = 0; i < ans1-ans2+1; i++) {
          /* code */
          cout<<"L";
        }
        cout<<"U";
        for (size_t i = 0; i < ans1; i++) {
          /* code */
          cout<<"R";
        }
        for (size_t i = 0; i < ans2; i++) {
          /* code */
          cout<<"D";
        }
        nL;
      ...
      {
        p1(ans)
        for (size_t i = 0; i < ans1-1; i++) {
          /* code */
          cout<<"UL";
        }
        for (size_t i = 0; i < ans2-ans1+1; i++) {
          /* code */
          cout<<"U";
        }
        cout<<"L";
