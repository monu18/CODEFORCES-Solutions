...
//	clock_t launch=clock();
 ...
 //num len = s.size();
	tc
	{
		ll n,k,ans=0,flag=0,f1=0,f2=0,sum=0,xx=0,minn=big,maxx=small;
		string s,ss,s1="",s2="";
    cin>>n;
    ll kk=0;
    ll mm=0;
    ...
    ll max_sum1 = maxSubArraySum(b, n-1);
    ll max_sum2 = maxSubArraySum(c, n-1);
    ll gg=max(max_sum1,max_sum2);
    if (gg>=sum) {
      /* code */
      no();
    }
